...
const modalWrapper: ViewStyle = {
  flex: 1, marginTop: -100, position: 'absolute', zIndex: 20, marginLeft: 0
}

const ModalMainContainer: ViewStyle = {
  width: 320, height: 350, marginLeft: 15, backgroundColor: '#242424', marginTop: 100, borderRadius: 10
}

const DetailsModal: ViewStyle = {
  margin: 10, height: 100, backgroundColor: '#121212'
}

const BackBtn: TextStyle = {
  color: '#ffffff', margin: 15, fontSize: 20, textAlign: 'right'
}
