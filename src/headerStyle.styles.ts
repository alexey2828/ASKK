...
const headerContainer: ViewStyle = {
  width: '95%', height: 60, backgroundColor: '#242424', borderRadius: 10, marginLeft: 20, marginRight: 20, marginTop: 10
}
...
const avatarImage: ImageStyle = {
  width: 45, height: 45, position: 'relative', zIndex: 10, margin: 8
}
